...
import com.ningct.community.entity.*;
...
class CommunityApplicationTests {
    ...
    public void loginticketselectTest(){
        System.out.println(loginTicketMapper.getLoginTicketByTicket("123").toString());
    }

    @Test
    public void loginticketupdateTest(){
        loginTicketMapper.updateState("123",1);
    }
